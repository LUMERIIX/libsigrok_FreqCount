 ...
 */
 ...
 #ifndef PROTOCOL_WRAPPERS_H_INCLUDED
    #define PROTOCOL_WRAPPERS_H_INCLUDED
    ...
    extern int timebase_get(struct sr_scpi_dev_inst *scpi,
            gchar **response);
    extern int timebase_set(struct sr_scpi_dev_inst *scpi,
            const gchar *value);
    ...
    #endif // PROTOCOL_WRAPPERS_H_INCLUDED
